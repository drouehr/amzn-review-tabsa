...
stop_words = ['this', 'the', 'is', 'are', 'it', 'a', 'an', 'and', 'but', 'or', 'for', 'nor', 'on', 'at', 'to', 'from', 'by', 'of', 'in', 'out', 'over', 'under', 'again', 'further', 'then', 'once', 'here', 'there', 'when', 'where', 'why', 'how', 'all', 'any', 'both', 'each', 'few', 'more', 'most', 'other', 'some', 'such', 'no', 'nor', 'not', 'so', 'too', 'will', 'would', 'could', 'can', 'seem', 'false', 'true', 'really', 'very', 'i', 'we', 'us', 'they', 'he', 'she', 'him', 'her', 'them', 'his', 'her', 'their', 'what']
stop_words_omitstart = ['and', 'or', 'but', 'for', 'on', 'at', 'to', 'from', 'by', 'in', 'out', 'over', 'under', 'again', 'further', 'then', 'here', 'all', 'both', 'each', 'can', 'when']
stop_words_omitend = ['the', 'a', 'an', 'it', 'i', 'we', 'they', 'he', 'she', 'his', 'her', 'their', 'and', 'or', 'there', 'here', 'all', 'any', 'both', 'other', 'some', 'such', 'same', 'from', 'by', 'is', 'are', 'when', 'what']
